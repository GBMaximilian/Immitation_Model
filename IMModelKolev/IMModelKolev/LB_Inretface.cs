...
namespace IMModelKolev
{
    ...
    class LB_Inretface
    {
        ...
        {
            Location = new D.Point(20, 70),
            Name = "CIR_L",
            Text = "Скорость выходного потока трафика",
            Size = new D.Size(200, 22)
        };
        ...
        public void Graf_LB()
        {
            ...
            chart1.ChartAreas["area"].AxisY.Interval = 250;


            chart1.Series.Add("GTk");
            chart1.Series.Add("VTk");
            chart1.Series.Add("Заполненность буфера");
            chart1.Series.Add("Потери на входе LB");

            chart1.Series["GTk"].Color = D.Color.Red;
            chart1.Series["VTk"].Color = D.Color.Green;
            chart1.Series["Заполненность буфера"].Color = D.Color.Blue;
            chart1.Series["Потери на входе LB"].Color = D.Color.Purple;
            ...
            chart1.Series["Заполненность буфера"].ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Line;
            chart1.Series["Потери на входе LB"].ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Line;
