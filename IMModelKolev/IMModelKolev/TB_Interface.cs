...
namespace IMModelKolev
{
    ...
    class TB_Interface
    {
        ...
        public void Graf_TB()
        {
            ...
            chart1.Series.Add("Заполненность буфера токенов");
            chart1.Series.Add("Потери");

            chart1.Series["GTk"].Color = D.Color.Red;
            chart1.Series["VTk"].Color = D.Color.Green;
            chart1.Series["Заполненность буфера токенов"].Color = D.Color.Blue;
            ...
            chart1.Series["Заполненность буфера токенов"].ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Line;
